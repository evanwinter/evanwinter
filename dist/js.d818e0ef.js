...
},{"_css_loader":"node_modules/parcel-bundler/src/builtins/css-loader.js"}],"src/js/theme.js":[function(require,module,exports) {
"use strict";
...
function () {
  ...
  _createClass(ThemeManager, [{
    ...
    value: function handleUpdate() {
      ...
      var nextTheme = THEMES[nextRandInt]; // set next theme
    ...
    value: function setTheme(theme) {
      ...
      paragraphs.forEach(function (paragraph) {
        return paragraph.style.color = color;
      });
    ...
    value: function setInitialTheme() {
      ...
      var numThemes = THEMES.length; // if hours is greater than number of themes, keep wrapping around the list
...
document.addEventListener("DOMContentLoaded", function () {
  var themeManager = new _theme.default();
  themeManager.setInitialTheme();
  themeManager.listen();
});
},{"../scss/styles.scss":"src/scss/styles.scss","./theme":"src/js/theme.js"}],"node_modules/parcel-bundler/src/builtins/hmr-runtime.js":[function(require,module,exports) {
